...
class HTTP {
    ...
    public function execute(){
        ...
        try{
            ...
            throw new Exception(Error::HTTP_REQUEST_ERROR);
        }
    ...
    public function validateResponse($response, $errno = null){
        ...
        if ($curl_error !== CURLE_OK){
            switch ($curl_error){
                case CURLE_HTTP_NOT_FOUND:      throw new Exception(Error::HTTP_RESPONSE_ERROR_CODE, $this->getResponseCode());
                case CURLE_OPERATION_TIMEOUTED: throw new Exception(Error::HTTP_REQUEST_TIMEOUT);
            }
            throw new Exception(Error::HTTP_RESPONSE_ERROR, $curl_error);
        }
